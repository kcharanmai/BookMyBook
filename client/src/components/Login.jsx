          ...
          <div className="max-w-lg mx-auto">
            ...
            <div className="divide-y divide-gray-200">
              <form onSubmit={handleLogin}className="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                ...
                {error ? <p className='text-red-600 text-base'>Email or Passord is not correct</p>:""}
                <p>If you haven't signed in yet, please <Link to="/sign-up" className='text-blue-600 underline'>Sign up</Link> here.</p>
                <div className="relative">
                  <button className="bg-blue-500 text-white rounded-md px-6 py-2 py-1">Login</button>
                </div>
              </form>
            </div>
            <hr />
